  ...
  <body>
    <header class="header-bar mb-3">
      <div class="container d-flex flex-column flex-md-row align-items-center p-3">
        <h4 class="my-0 mr-md-auto font-weight-normal"><a href="/" class="text-white">Sociality</a></h4>

        @auth
        
        {{-- if it is authorize will show different --}}         
        ...
        {{-- the form can be seen if it is not auth --}}
    ...
    {{-- access to a message if the sign in or logout is succesfull --}}
